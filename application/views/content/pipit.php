    ...
    <div class="container">
      ...
      <div class="row" style="margin-top:20px;">
        ...
        <div class="col-sm-6" style="margin-top: 30px;"> 
          ...
          <p>Motto of Life "Believe, There is the best plan,<br>Everything is Ok in the end. if it's not OK,Then it's not the end."</p>
        </div>

        <div class="col-sm-3 text-center social" style="margin-top: 30px;">
          <p>Phone:<strong>+628 5840350804</strong></p>
          <p>Email:<strong>pipit98kurniasari@gmail.com</strong></p>
            <a href="#">
            <span class="fa-stack">
        ...
        <div class="col-sm-12">
          <div class="card card-block text-xs-left">
            <h5><i class="fa fa-user fa-fw"></i>Biodata</h5>
              <p>Name           : Pipit Kurnia Sari<br>
                 Date of birth  : Mekarsari, 28 August 1997<br>
                 Address        : Lrg Sarjana Tugu Timbangan KM 32 Palembang</p>
          </div>
        </div>
      </div>
  <div class="row">
