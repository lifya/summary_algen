...
<div class="navbar navbar-default navbar-fixed-top" role="navigation" id="myNavbar">
    ...
    <div class="container">
      <div class="teacher-name">
        <div class="row">
        <div class="col-sm-9">
          <h2><strong>Lifya Fitriani</strong></h2>
        </div>
        </div>
      </div>
      ...
      <div class="row" style="margin-top:20px;">
        <div class="col-sm-3"> 
          <a href="#"><img src="<?php echo base_url()?>assets/images/lifya.jpg" /> </a>
        </div>

        <div class="col-sm-6" style="margin-top: 30px;"> 
          <h5>Student of University Sriwijaya 15',</h5>
          <p>Informatic Engineering</p>
          <p>Motto of Life : Do your best, so you can’t blame yourself for anything</p>
        </div>

        <div class="col-sm-3 text-center social" style="margin-top: 30px;">
          <p>Phone:<strong>+628 5272963978</strong></p>
          <p>Email:<strong>lifyafitriani@gmail.com</strong></p>
            <a href="#">
            <span class="fa-stack">
        ...
        <div class="col-sm-12">
          <div class="card card-block text-xs-left">
            <h5><i class="fa fa-user fa-fw"></i>Biodata</h5>
              <p>Name           : Lifya Fitriani<br>
                 Date of birth  : Palembang, 12 February 1998<br>
                 Address        : Palembang</p>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12">
        <div class="card card-block">
          ...
          <ul class="list-group" style="margin-top:15px;margin-bottom:15px;">
            ...
            <li class="list-group-item">Mobile Aplication</li>
          </ul>
        </div>
    </div>
  </div>
